...
- e53c315: Fix `IngressRoutes` replacement (app rename / agent move) failing with a 500 `failed to reload ingress` when the new app keeps the same host.
...
- Updated dependencies [4e6564d]
  - @opsen/docker-compose@0.3.2
