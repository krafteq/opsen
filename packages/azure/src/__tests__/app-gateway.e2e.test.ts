 ...
 *   - App Gateway `opsen-e2e-appgw` in rg-dev / germanywestcentral
 *   - DNS zone `az.krafteq.de` in rg-dev
 *   - Key Vault `opsen-dev-kv`
 */
...
const gatewayName = 'opsen-e2e-appgw'
const dnsZoneName = 'az.krafteq.de'
const keyVaultName = 'opsen-dev-kv'
