...
const dnsZoneName = 'az.krafteq.de'
const kvVaultUrl = 'https://opsen-dev-kv.vault.azure.net/'
const subscriptionId = '07de39e7-6993-4604-acac-bd3ce428551d'
...
// CNAME: aca.az.krafteq.de → {app-name}.{env-default-domain}
  ...
  deployed.app.identity.apply((identity) => {
    if (identity?.principalId) {
      new authorization.RoleAssignment('e2e-webapp-kv-role', {
        scope: `/subscriptions/${subscriptionId}/resourceGroups/${resourceGroupName}/providers/Microsoft.KeyVault/vaults/opsen-dev-kv`,
